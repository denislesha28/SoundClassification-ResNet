...
if __name__ == "__main__":
    ...
    experiment_root = Path(args.cvpath)
    print(f"Experiment root: {experiment_root}")  # Debugging line
    print(f"Exists: {experiment_root.exists()}")  # Debugging line
    print(f"Is directory: {experiment_root.is_dir()}")  # Debugging line
